...
def first_display():
    clear()
    print_lime("Demarrage ScanPlus...")
    banner()
    print_lime("Quel type de scan voulez-vous effectuer? \n")
    print_lime("Tapez juste le numéro de scan que vous desirez effectuer, puis tapez la touche entrée du clavier\n")
