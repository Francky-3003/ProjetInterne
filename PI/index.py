...
def first_display():
    clear()
    print_blue("Demarrage ScanPlus...")
    banner()
    print_blue("Quel type de scan voulez-vous effectuer? \n")
    print_blue("Tapez juste le numéro de scan que vous desirez effectuer, puis tapez la touche entrée du clavier\n")
