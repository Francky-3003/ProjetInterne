...
# à executer d'abord
# export PYTHONPATH="${PYTHONPATH}:/home/Francky-3003/PI/"
# import os
...
def first_display():
    clear()
    print_green("Demarrage ScanPlus...")
    banner()
    print_green("Quel type de scan voulez-vous effectuer? \n")
    print_green("Tapez juste le numéro de scan que vous desirez effectuer, puis tapez la touche entrée du clavier\n")
