    ...
    with open(userPass, "r") as up:
        ...
        for l in liste:
            ...
            if resp.status_code == 200:
                ...
                if k == 10:
                    print_red("[-] L'attaque brutefoce est possible sur ce site car plus de 10 connexions incorrectes ont pu être effectuées...")
                    print_red("[-] Ce site n'a pas de nombre limite de connexions érronées")
            else:
                print_green("[+] L'attaque bruteforce n'est pas possible !!")
                print_green("[+] Ce site a un nombre limite de connexion érronées")
                break
...
def is_bruteforce():
    print_white("\n\n===============================================================================================")
    print_white("Vous avez choisi le scan is_bruteforce qui vérifie si l'attaque bruteforce est possible")
